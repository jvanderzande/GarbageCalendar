		...
		if
		 ...
		 then
			...
			if (EventNotificationscript or '') ~= '' then
				...
				dprintlog('---->check : ' .. GC_scriptpath .. '' .. EventNotificationscript, 1)
				...
				dprintlog('---->Notification script started: ' .. EventNotificationscript, 1)
				...
				--print("4.GC_scriptpath:"..GC_scriptpath)
				dofile(GC_scriptpath .. '' .. EventNotificationscript)
				dprintlog('---->Notification script ended: ' .. GC_scriptpath .. '' .. EventNotificationscript, 1)
			end
		end
	end
end
